...
functionality you're adding in your contribution. Check out the [test](https://github.com/hashicorp/terraform-google-consul/tree/master/test) folder for instructions on running the 
automated tests. 
